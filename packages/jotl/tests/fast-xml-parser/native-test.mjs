/**
 * Native Node.js test for JOTL + fast-xml-parser integration
 * Run with: node --test tests/fast-xml-parser/native-test.mjs
 */
...
describe('JOTL + fast-xml-parser integration', () => {
  it('transforms ABAP package fixture to XML', () => {
    const schema = {
      'pak:package': {
    ...
    // Transform using JOTL
    const fastXmlObject = transform(PACKAGE_FIXTURE.package, schema);
    ...
    console.log('✓ JOTL transformation executed');
    console.log('✓ XML generated successfully');

    // Compare structures
    assert.deepStrictEqual(actualStructure, expectedStructure, 'Generated XML should match expected structure');
