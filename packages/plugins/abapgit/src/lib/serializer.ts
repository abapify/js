...
import { serializePackage } from '../objects/devc/index.js';
import { serializeClass } from '../objects/clas/index.js';
import { serializeInterface } from '../objects/intf/index.js';
import { serializeDomain } from '../objects/doma/index.js';
import { serializeDataElement } from '../objects/dtel/index.js';
...
<abapGit version="v1.0.0" serializer="LCL_OBJECT_DEVC" serializer_version="v1.0.0">
 <asx:abap xmlns:asx="http://www.sap.com/abapxml" version="1.0">
  ...
  private generateObjectXml(obj: AdkObject): string {
    // Use object-specific serializers
    if (isPackage(obj)) {
      return serializePackage(obj as Package);
    }
    if (isClass(obj)) {
      return serializeClass(obj as Class);
    }
    if (isInterface(obj)) {
      return serializeInterface(obj as Interface);
    }
    if (isDomain(obj)) {
      return serializeDomain(obj as Domain);
    }
