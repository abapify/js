...
```typescript
import { generateSchemaLiteral } from '@abapify/ts-xsd-core';
...
```typescript
import { generateSchemaFile } from '@abapify/ts-xsd-core';
...
```typescript
import { initContext, applyXmlns, applyImports } from '@abapify/ts-xsd-core/codegen/presets';
...
```typescript
import { generateSchemaLiteral, generateInterfaces, parseXsd } from '@abapify/ts-xsd-core';
...
- [ts-xsd-core README](../README.md)
- [ts-xsd-core AGENTS.md](../AGENTS.md)
- [adt-schemas-xsd-v2](../../adt-schemas-xsd-v2/README.md) - Real-world usage
