 ...
 */
export class TmTaskScenario extends Scenario<typeof transportmanagmentSingle> {
...
export class TmCreateScenario extends Scenario<typeof transportmanagmentCreate> {
...
export class TmFullScenario extends Scenario<typeof transportmanagmentSingle> {
  readonly schema = transportmanagmentSingle;
