 ...
 * 
 * Generates TypeScript schema files from XSD using ts-xsd-core.
...
import { generateWithPreset } from '../../ts-xsd-core/src/codegen/presets';
...
function generateSchemas(options: GenerateOptions): { generated: string[]; failed: string[] } {
  ...
  for (const schemaName of schemas) {
    ...
    try {
      ...
      console.log(`✅ [${sourceName}] Generated ${schemaName}`);
  ...
  console.log(`✅ [${sourceName}] Generated index.ts`);
...
function main() {
  ...
  console.log(`\n📊 Summary: ${totalGenerated} schemas generated, ${totalFailed} failed`);
