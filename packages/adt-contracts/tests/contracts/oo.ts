...
export class ClassesScenario extends ContractScenario {
...
export class ClassSourceScenario extends ContractScenario {
...
export class InterfacesScenario extends ContractScenario {
...
export class ClassRunScenario extends ContractScenario {
