...
import type { TypedSchema, InferTypedSchema, SchemaLike } from '@abapify/adt-schemas';
 ...
 */
export type SpeciSchema<T, S extends SchemaLike = SchemaLike> = 
  TypedSchema<T, S> & Serializable<T>;
