 ...
 * Uses ts-morph for TypeScript code generation.
 *
 * Two modes:
...
import { generateInterfaces as generateInterfacesFromSchema } from '../codegen/interface-generator';
 ...
 *   generators: [
 *     interfaces(),                    // interfaces with imports
 *     interfaces({ flatten: true }),   // fully flattened types
 *   ],
 * });
 * ```
 */
