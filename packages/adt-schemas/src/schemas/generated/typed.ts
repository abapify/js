...
import type { IncludesSchema } from './types/sap/includes.types';
import type { GroupsSchema } from './types/sap/groups.types';
import type { FmodulesSchema } from './types/sap/fmodules.types';
import type { FincludesSchema } from './types/sap/fincludes.types';
...
import type { ObjectPropertiesSchema } from './types/custom/objectProperties.types';
...
import type { DdlxSourceSchema } from './types/custom/ddlxSource.types';
import type { DtebSourceSchema } from './types/custom/dtebSource.types';
...
export const programs: TypedSchema<ProgramsSchema> = typedSchema<ProgramsSchema>(_programs);
import _includes from './schemas/sap/includes';
export const includes: TypedSchema<IncludesSchema> = typedSchema<IncludesSchema>(_includes);
import _groups from './schemas/sap/groups';
export const groups: TypedSchema<GroupsSchema> = typedSchema<GroupsSchema>(_groups);
import _fmodules from './schemas/sap/fmodules';
export const fmodules: TypedSchema<FmodulesSchema> = typedSchema<FmodulesSchema>(_fmodules);
import _fincludes from './schemas/sap/fincludes';
export const fincludes: TypedSchema<FincludesSchema> = typedSchema<FincludesSchema>(_fincludes);
...
export const domain: TypedSchema<DomainSchema> = typedSchema<DomainSchema>(_domain);
import _dataelements from './schemas/sap/dataelements';
export const dataelements: TypedSchema<DataelementsSchema> = typedSchema<DataelementsSchema>(_dataelements);
...
export const dataelementWrapper: TypedSchema<DataelementWrapperSchema> = typedSchema<DataelementWrapperSchema>(_dataelementWrapper);
import _blueSource from './schemas/custom/blueSource';
export const blueSource: TypedSchema<BlueSourceSchema> = typedSchema<BlueSourceSchema>(_blueSource);
...
import _objectProperties from './schemas/custom/objectProperties';
export const objectProperties: TypedSchema<ObjectPropertiesSchema> = typedSchema<ObjectPropertiesSchema>(_objectProperties);
...
import _ddlxSource from './schemas/custom/ddlxSource';
export const ddlxSource: TypedSchema<DdlxSourceSchema> = typedSchema<DdlxSourceSchema>(_ddlxSource);
import _dtebSource from './schemas/custom/dtebSource';
export const dtebSource: TypedSchema<DtebSourceSchema> = typedSchema<DtebSourceSchema>(_dtebSource);
