...
import { Component, DataElement, DataElementInput, Domain, DomainInput } from '@abapify/components';
...
test('generate abapgit project from CDS model', async () => {
    ...
    function processDataElement(dataElement: DataElementInput, generate?: boolean) {
        ...
        if ('domain' in dataElement && typeof dataElement.domain === "object" && 'generate' in dataElement.domain) {
