...
Defined in [`packages/adt-mcp/src/lib/tools/delete-badi.ts`](https://github.com/abapify/adt-cli/blob/main/packages/adt-mcp/src/lib/tools/delete-badi.ts).
...
```ts
{
  ...
  badiName: string; // Enhancement Implementation name
