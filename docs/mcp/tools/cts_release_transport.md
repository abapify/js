...
Defined in [`packages/adt-mcp/src/lib/tools/cts-release-transport.ts`](https://github.com/abapify/adt-cli/blob/main/packages/adt-mcp/src/lib/tools/cts-release-transport.ts).
